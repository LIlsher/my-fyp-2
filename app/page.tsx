...
const generateUserId = (): string => {
  ...
  return `user_${timestamp}_${randomNum}_${randomChars}`;
};
  ...
  const sendMessage = async (messageContent: string) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://lilsher-rag.onrender.com/api/chat",
        {
          method: "POST",
          headers: {
          ...
          <div className="flex flex-col items-center justify-center min-h-[80vh] space-y-8">
            ...
            <div className="w-full max-w-2xl">
              ...
              <p className="text-sm text-gray-500 mt-4 text-center">
                This AI assistant provides general guidance. For official
                matters, contact the appropriate department.
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="space-y-6">
            ...
            <div className="text-center py-6">
              ...
              <p className="text-gray-600">
                Your AI-powered academic guidance companion
              </p>
            </div>
